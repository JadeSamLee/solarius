...
import IDL from "../idl/solarius.json";
import { Solarius } from "@/idl/solarius";
...
// Solarius game program ID
export const PROGRAM_ID = new PublicKey(IDL.address);

export function getProgram(provider: AnchorProvider) {
  return new Program(IDL as Solarius, provider);
}
...
export type PlayerData = IdlAccounts<Solarius>["playerData"]
export type GameData = IdlAccounts<Solarius>["gameData"]
