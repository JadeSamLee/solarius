...
public class AnchorService : MonoBehaviour
{
    ...
    private SolariusClient anchorClient;
    ...
    private async void OnLogin(Account account)
    {
        ...
        anchorClient = new SolariusClient(Web3.Rpc, Web3.WsRpc, AnchorProgramIdPubKey);
    ...
    public async Task InitAccounts(bool useSession)
    {
        ...
        var initTx = SolariusProgram.InitPlayer(accounts, levelSeed, AnchorProgramIdPubKey);
        tx.Add(initTx);
    ...
    public async void ChopTree(bool useSession, Action onSuccess)
    {
        ...
        if (useSession)
        {
            ...
            var chopInstruction = SolariusProgram.ChopTree(chopTreeAccounts, levelSeed, transactionCounter, AnchorProgramIdPubKey);
